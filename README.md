...
### 📃 `wit list [archive] [-l]`
Lists all files in the archive by showing their `identity` hash and relative path (e.g. `136a5a2f...  compress.go`). Use `-l` for detailed list view (shows type, size, and mode). Supports `.zip` archives.
